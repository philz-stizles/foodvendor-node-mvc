...
exports.getOne = (Model, populate) => catchAsync(async (req, res, next) => {
  ...
  res.json({ status: true, data: existingModel, message: 'retrieved successfully' })
})
...
exports.deleteOne = Model => catchAsync(async (req, res, next) => {
  ...
  res.status(204).json({ status: true, data: null, message: 'Deleted successfully'})
})
...
exports.updateOne = Model => catchAsync(async (req, res, next) => {
  ...
  res.json({ status: true, data: updatedModel, message: 'Updated successfully' })
});
